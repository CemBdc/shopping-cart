...
namespace ShoppingCart.Test.Campaign
{
    public class CampaignTest
    {
        ...
        {
            var amountCampaign = campaignFactory.Get(20, 3, Utils.Enums.CampaignTypes.Amount);
        ...
        {
            var amountCampaign = campaignFactory.Get(20, minProductQuantity, Utils.Enums.CampaignTypes.Amount);
        ...
        {
            var rateCampaign = campaignFactory.Get(20, 3, Utils.Enums.CampaignTypes.Rate);
        ...
        {
            var rateCampaign = campaignFactory.Get(20, minProductQuantity, Utils.Enums.CampaignTypes.Rate);
